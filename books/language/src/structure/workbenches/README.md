...
from which it generates 2D or 3D *models*.

In the following pages, you will first learn about the elements that compose
a workbench of any type.
Then, we will explore the different types of workbenches.
